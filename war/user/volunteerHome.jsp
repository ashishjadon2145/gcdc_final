...
<%	
	...
	if(session.getAttribute("volunteerId")!=null)
		userId = session.getAttribute("volunteerId").toString();
	else
...
<head>
	...
	<title>Vaccinate : Volunteer Home </title>
	  ...
	  <hr/ >
		<ul class="tabs-content ">  
        		...
        		<h3>Profile Information</h3>	
        			...
        			<input type="hidden" id="action" name="source" value="volunteer" />
			...
			<li id = "main-contentTab">
		  		<div class="row">
					...
					if(callRecordList==null || callRecordList.size()==0)
						...
						out.println("<input type=\"hidden\" id=\"source\" name=\"source\" value=\"volunteer\" />");

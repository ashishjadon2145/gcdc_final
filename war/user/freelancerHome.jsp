      ...
      <hr/ >
		<ul class="tabs-content ">  
        		...
        		<h3>Profile Information</h3>	
        			...
        			<input type="hidden" id="action" name="source" value="freelancer" />
    					...
    					<legend>General Detail</legend>
							<div class="row">
								<div class="six columns">
									...
									%>
        							<label for="myFile">Upload your photograph</label>
        			...
        			<fieldset>
    					<legend>Qualification & Operational Details</legend>
    						<div class="row">
								...
								<input type="hidden" value="6" name="vacciCenterType" />
								<!--
    						...
    						<div class="row">
        						...
        						-->
        						<input type="hidden" value="YES" name="homeServiceRadio" />
								<div class="five columns">
										<div class="twelve columns">
    						...
    						<div class="row">
								<div class="twelve columns">
										<div class="twelve columns">
		        							<label>Details of your work experience and refrences (if any)</label>
		        							<textarea name="aboutMe" id="aboutMe" placeholder="Details of your work experience and refrences"><%=p1.aboutMe%></textarea>
											<label for="aboutMe" class="error" id="aboutMeError">Please enter details of your work experience</label>
		        						</div> 
		        						<!--  
										<div class="six columns">
			...
			<li id = "main-contentTab">
		  		<div class="row">
					...
					if(appointmentList==null || appointmentList.size()==0)
						...
						out.println("<input type=\"hidden\" id=\"source\" name=\"source\" value=\"freelancer\" />");

...
//		    
	...
	function getVaccinationSchedule(dob){
		...
		data = [
		            {
		              "date":Date.parseExact(dob,'dd-MM-yyyy').addDays(1).toString("yyyy-MM-dd"),
		              "vaccination" : ["BCG - Injection", "Hep B-1"]    		            	
		            },
		        {
		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(41).toString("yyyy-MM-dd"),
		           	 "vaccination" : ["DTP 1", "IPV -1","Hep-B 2","Hib 1","Rotavirus 1", "PCV 1" ] 
		            },
		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(69).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["DTP -2 ", "IPV -2", "Hib 2", "Rotavirus 2", "PCV 2"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(97).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["DTP -3", "IPV -3", "Hib 3", "Rotavirus 3", "PCV 3"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(181).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["OPV 1", "Hep-B 3"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(272).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["OPV 2", "Measles"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(364).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["Hep-A 1"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(455).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["MMR 1", "Varicella 1", "PCV booster"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(486).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["DTP B!", "IPT B1", "Hib B1"] 
   		            },
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(547).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["Hep-A 2"] 
   		            },
   		            
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(729).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["Typhoid 1"] 
   		            },
   		            
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(1642).toString("yyyy-MM-dd"),
   		           	 "vaccination" : ["DTP B2", "OPV 3", "MMR 2", "Varicella 2", "Typhoid 2"] 
   		            },
   		            
   		         {
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(3651).toString("yyyy-MM-dd"),
		...
		var data = [
		            {
		              ...
		              "date":Date.parseExact(dob,'dd-mm-yyyy').addDays(1).toString("dd-MM-yyyy"),
		              "vaccination" : ["BCG - Injection", "Hep B-1"],
		              "comments" : ""
		            },
		        {
		            	"age" : "<strong>6 Weeks</strong>",
		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(41).toString("dd-MM-yyyy"),
		           	 "vaccination" : ["DTP 1", "IPV -1","Hep-B 2","Hib 1","Rotavirus 1", "PCV 1" ],
		            ...
		            },
		         {
		            	"age" : "<strong>10 Weeks</strong>",
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(69).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["DTP -2 ", "IPV -2", "Hib 2", "Rotavirus 2", "PCV 2"],
   		          "comments" : ""
   		            ...
   		            },
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(97).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["DTP -3", "IPV -3", "Hib 3", "Rotavirus 3", "PCV 3"],
   		          "comments" : "<strong>Rotavirus :</strong> Only 2 doses of RV1 are recommended at present."
   		            },
   		         {
   		            	"age" : "<strong>6 Months</strong>",
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(181).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["OPV 1", "Hep-B 3"],
   		            ...
   		            },
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(272).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["OPV 2", "Measles"],
   		          "comments" : ""
   		            },
   		         {
   		            	"age" : "<strong>12 Months</strong>",
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(364).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["Hep-A 1"],
   		            ...
   		            },
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(455).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["MMR 1", "Varicella 1", "PCV booster"],
   		            ...
   		            },
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(486).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["DTP B!", "IPT B1", "Hib B1"],
   		            ...
   		            },
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(547).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["Hep-A 2"],
   		          "comments" : "<strong>Hepatitis A :</strong> For both killed and live hepatitis-A vaccines 2 doses are recommended"
   		            },
   		            
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(729).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["Typhoid 1"],
   		            ...
   		            
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(1642).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["DTP B2", "OPV 3", "MMR 2", "Varicella 2", "Typhoid 2"],
   		            ...
   		            
   		         {
   		           	 ...
   		           	 "date" :Date.parseExact(dob,'dd-MM-yyyy').addDays(3651).toString("dd-MM-yyyy"),
   		           	 "vaccination" : ["TDAP", "HPV"],

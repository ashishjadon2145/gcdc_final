...
public class VaccibotClassify1 extends HttpServlet {
	//declaring and initialize with blank string
	public static String[] vocab = {"","","","","","",""}; 
	public static double[] priorProbability = {0.142857, 0.142857, 0.142857, 0.142857, 0.142857, 0.142857, 0.142857}; 
